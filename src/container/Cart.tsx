                ...
                <>
                    <View style={{ height: '35%'}}>
                        <FlatList
                            ...
                            data={products} 
                            keyExtractor={(item) =>(item.product?item.product.id:"")}
                            renderItem={(item) => <ItemList data={item.item} />}
                        />
                    </View>
                    <View
                        style={{
                    ...
                    >
                        ...
                        >
                            ...
                            <Button
                                mode="contained"
                                onPress={() => console.log('apply code')}
                            >
                                Apply
                            </Button>
                        </View>
                    ...
                    <View style={{ flex: 2, paddingHorizontal: '10%' }}>
                        ...
                        >
                            ...
                            <Text variant="labelLarge">
                                $ {(items.totalPrice + 4.99).toFixed(2)}
                            </Text>
                        </View>
                    </View>
                    <View style={{ flex: 1, paddingHorizontal: '5%' }}>
                        {/* payment button */}
                        <Button mode="contained" contentStyle={{ height: 60 }}>
                            Proceed to Checkout
                        </Button>
                    </View>
                </>
